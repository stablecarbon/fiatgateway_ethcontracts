...
contract('PermissionedToken', _accounts => {
    ...
    // The test players:
    const tokenOwner = accounts.tokenOwner;
    const tokenRegulatorProxyOwner = accounts.tokenRegulatorProxyOwner;
    const tokenValidator = accounts.tokenValidator;
    const tokenValidator2 = accounts.tokenValidator2;
    const carbonUSDOwner = accounts.carbonUSDOwner;
    const carbonUSDRegulatorProxyOwner = accounts.carbonUSDRegulatorProxyOwner;
    const carbonUSDValidator = accounts.carbonUSDValidator;
    const attacker = accounts.attacker;
    const userSender = accounts.tokenOwner;
    const userReceiver = accounts.tokenOwner;
