    ...
    describe('before upgrading to v1', function () {
        ...
        describe('call to proxy to addValidator', function () {
            ...
            beforeEach(async function() {
                ...
                await this.regulatorProxy.claimValidatorOwnership()
            })
        ...
        describe('owner calls upgradeTo', function () {
            ...
            describe('Calls proxy', function () {
                beforeEach(async function () {
                    ...
                    await this.regulatorProxy.claimPermissionOwnership()
                    await this.regulatorProxy.claimValidatorOwnership()
                    ...
                    await this.logic_v1.claimPermissionOwnership()
                    await this.logic_v1.claimValidatorOwnership()
