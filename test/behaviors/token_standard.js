function shouldBehaveLikeTokenStandard(tokenOwner, owner, recipient, anotherAccount) {
  ...
  describe('transfer', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the sender does not have enough balance', function () {
        ...
        it('reverts', async function () {
          await expectRevert(this.token.transfer(to, amount, { from: owner }))
        })
      })
    ...
    describe('when the recipient is the zero address', function () {
      ...
      it('reverts', async function () {
        await expectRevert(this.token.transfer(to, 100, { from: owner }))
      })
    })
  })
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        ...
        describe('when the owner does not have enough balance', function () {
          ...
          it('reverts', async function () {
            await expectRevert(this.token.transferFrom(owner, to, amount, { from: spender }))
          })
        })
      })
...
module.exports = shouldBehaveLikeTokenStandard