function shouldBehaveLikeTokenPausable(tokenOwner, owner, recipient, anotherAccount) {
  ...
  describe('pausable token', function () {
    ...
    describe('transfer', function () {
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await expectRevert(this.token.transfer(recipient, 100, { from: owner }))
      })
    })
    ...
    describe('approve', function () {
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await expectRevert(this.token.approve(anotherAccount, 40, { from: owner }))
      })
    })
    ...
    describe('transfer from', function () {
      ...
      it('reverts when trying to transfer from when paused', async function () {
        ...
        await expectRevert(this.token.transferFrom(owner, recipient, 40, { from: anotherAccount }))
      })
    })
    ...
    describe('increase approval', function () {
      ...
      it('reverts when trying to increase approval when paused', async function () {
        ...
        await expectRevert(this.token.increaseApproval(anotherAccount, 40, { from: owner }))
      })
    })
  })
}

module.exports = shouldBehaveLikeTokenPausable