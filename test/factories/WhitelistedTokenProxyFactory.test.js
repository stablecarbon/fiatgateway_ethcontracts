...
contract('WhitelistedToken Factory creating WT proxies', _accounts => {
    ...
    beforeEach(async function () {
        ...
        this.cdToken = await CarbonDollar.new(ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, {from: other_owner })
        ...
        await this.cdProxyFactory.createToken(this.cdToken.address, this.cdRegulatorAddress, { from: proxy_owner })
    ...
    describe('Casting children to WhitelistedToken and WhitelistedTokenProxy', function () {
        ...
        describe('Proxy delegates calls to implementation', function () {
            ...
            beforeEach(async function () {
                ...
                await this.cdRegulator.setMinter(minter, {from:validator})
                await this.cdRegulator.setWhitelistedUser(whitelisted, {from:validator})
                await this.cdRegulator.setWhitelistedUser(this.cusd_0.address, {from:validator})
            ...
            describe('mintCUSD', function () {
                it('minter calls', async function () {
                    // console.log(await this.regulator_WT.isWhitelistedUser(whitelisted))
