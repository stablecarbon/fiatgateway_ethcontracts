 ...
 * what constitutes a "whitelisted/nonlisted/blacklisted" user. Since a CarbonDollar
...
contract CarbonDollarRegulator is Regulator {
    ...
    function _setWhitelistedUser(address _who) internal {
        require(permissions.isPermission(permissions.CONVERT_CARBON_DOLLAR_SIG()), "Burning CUSD not supported");
